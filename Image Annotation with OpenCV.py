...
image_path = 'example.jpg'  # Replace with your actual file
...
cv2.circle(image_rgb, (center1_x, center1_y), 15, (0, 255, 0), -1)  # Green circle
cv2.circle(image_rgb, (center2_x, center2_y), 15, (0, 0, 255), -1)  # Red circle

# Step 4: Draw Connecting Line
cv2.line(image_rgb, (center1_x, center1_y), (center2_x, center2_y), (0, 255, 0), 3)

# Step 5: Add Text Annotations
font = cv2.FONT_HERSHEY_SIMPLEX
cv2.putText(image_rgb, 'Region 1', (top_left1[0], top_left1[1] - 10),
            font, 0.7, (0, 255, 255), 2, cv2.LINE_AA)
cv2.putText(image_rgb, 'Region 2', (top_left2[0], top_left2[1] - 10),
...
# Step 6: Add Bi-Directional Arrow (for height)
